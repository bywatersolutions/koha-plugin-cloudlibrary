...
$(document).ready(function(){
    ...
    if( $("body#opac-user").length > 0 ) {
        $("#opac-user-views ul").append('<li class="nav-item" role="presentation"><a href="#opac-user-cloudlibrary" class="nav-link" data-bs-toggle="tab" data-tabname="opac-user-cloudlibrary" data-bs-target="#opac-user-cloudlibrary_panel" role="tab" aria-controls="opac-user-cloudlibrary">Cloud Library Account</a></li>');
        $("#opac-user-views .tab-content").append('<div id="opac-user-cloudlibrary_panel" class="tab-pane" role="tabplanel" aria-labelledby="opac-user-cloudlibrary"><div id="content-3m">Search the catalog to find and place holds or checkout Cloud Library items. Click the covers to visit the Cloud Library site and login to download items or get the apps</div></div>');
        GetPatronInfo();
    }
